...
/*
    This file is to support the serialization and deserialization of basic
    types, including: bool,char,unsigned char,signed char,wchar_t,unsigned
    short,signed short,unsigned int, signed int,unsigned long,signed long,long
    long,unsigned long long,float,double,long double.

    Note that type 'long double' will be converted to 'double' during
    (de)serialization and loss precision.
*/
