...
/*
	...
	implements:
		...
		void set_key_value(JSON_Object *,const char *,const _T &);
		void set_key_value(JSON_Array *,const _T &);
		void get_value(JSON_Object *,const char *,_T *);
		void get_value(JSON_Array *,size_t index,_T *);
...
template<typename _T>
inline void set_key_value(JSON_Object *obj,const char *key, _T * const res){
	set_key_value(obj,key,*res);
}
template<typename _T>
inline void set_key_value(JSON_Array *arr, _T * const res){
	set_key_value(arr,*res);
}
